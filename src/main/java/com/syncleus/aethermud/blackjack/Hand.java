...
import static com.syncleus.aethermud.blackjack.Hand.Category.*;
import static com.syncleus.aethermud.blackjack.Hand.Rank.*;
import static com.syncleus.aethermud.blackjack.Hand.Suit.*;
...
public class Hand implements Comparable<Hand> {
    ...
    public boolean isRoyalFlush() {
        Optional<Card> aceCard = cards.stream().filter(card -> card.getRank().equals(ACE)).findAny();
        Suit desiredSuit;
