...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        BasicRoom lobby = new BasicRoom(1, "Lobby", Optional.of(2), Optional.<Integer>absent(), Optional.<Integer>absent(), Optional.<Integer>absent(), Optional.<Integer>absent(), Optional.<Integer>absent(),
                "This is the lobby. It's pretty empty and the paint still smells fresh.\r\n");
        BasicRoom hallway = new BasicRoom(2,"Hallway", Optional.of(3), Optional.<Integer>absent(), Optional.<Integer>absent(), Optional.of(1), Optional.<Integer>absent(), Optional.<Integer>absent(),
                "This is the hallway. It's long and hallway-ish with exposed wires and floorboards showing.\r\n");
        BasicRoom intake = new BasicRoom(3, "Intake", Optional.<Integer>absent(), Optional.of(6), Optional.<Integer>absent(), Optional.of(2),Optional.<Integer>absent(), Optional.<Integer>absent(),
                "This is the intake area.  People are lined up like cattle waiting to be prodded.\r\n");
        BasicRoom janitorialCloset = new BasicRoom(6, "Closet", Optional.<Integer>absent(), Optional.<Integer>absent(), Optional.of(3), Optional.of(7), Optional.<Integer>absent(), Optional.<Integer>absent(),
                "You find yourself in the janitorial closet.  It smells like bleach.\r\n");
        BasicRoom toilet = new BasicRoom(7, "Toilet", Optional.of(6), Optional.<Integer>absent(), Optional.<Integer>absent(), Optional.<Integer>absent(), Optional.of(8), Optional.<Integer>absent(),
