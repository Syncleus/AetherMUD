...
public class CreeperLineBasedFrameDecoder extends FrameDecoder {
...
private int discardedBytes;
     ...
     */
    public CreeperLineBasedFrameDecoder(final int maxLength) {
     ...
     */
    public CreeperLineBasedFrameDecoder(final int maxLength, final boolean stripDelimiter, final boolean failFast) {
