...
/**
 * Created by kearney on 5/17/15.
 */
public class CreeperDelimiterBasedFrameDecoder extends FrameDecoder {
    ...
    private final CreeperLineBasedFrameDecoder lineBasedDecoder;
     ...
     */
    public CreeperDelimiterBasedFrameDecoder(int maxFrameLength, ChannelBuffer delimiter) {
     ...
     * @param delimiter  the delimiter
     */
    public CreeperDelimiterBasedFrameDecoder(
     ...
     */
    public CreeperDelimiterBasedFrameDecoder(int maxFrameLength, ChannelBuffer... delimiters) {
    ...
    public CreeperDelimiterBasedFrameDecoder(
        ...
        if (isLineBased(delimiters) && !isSubclass()) {
            lineBasedDecoder = new CreeperLineBasedFrameDecoder(maxFrameLength, stripDelimiter, failFast);
    ...
    private boolean isSubclass() {
        return getClass() != CreeperDelimiterBasedFrameDecoder.class;
    }
