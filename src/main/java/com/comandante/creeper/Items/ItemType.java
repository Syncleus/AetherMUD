...
public enum ItemType {
    ...
    ItemType(Integer itemTypeCode, String itemShortName, String itemName, String itemDescription, boolean isDisposable) {
    ...
    public Item create() {
        return new Item(getItemName(), getItemDescription(), getItemShortName(), UUID.randomUUID().toString(), getItemTypeCode());
    }
